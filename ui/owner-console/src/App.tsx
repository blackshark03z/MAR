...
function TasksPage({ tasks, projects, workspace, reloadTasks }: any) {
  ...
  useEffect(()=>{if(!selected && scoped.length)setSelected((scoped.find((t:any)=>isActionableBlockedTask(t,projects))||scoped[0]).id);if(selected&&!scoped.some((t:any)=>t.id===selected))setSelected('')},[tasks,workspace,projects])
