...
var token = document.querySelector("meta[name=\"mar-owner-token\"]")?.content || "";
...
var getRuntime = () => api("/api/runtime");
var getProjects = () => api("/api/projects");
var getTasks = () => api("/api/tasks");
var getUsage = (projectId = "") => api(`/api/usage${projectId ? `?project_id=${encodeURIComponent(projectId)}` : ""}`);
var getTaskStatus = (id) => api(`/api/tasks/${encodeURIComponent(id)}/status`);
var getTaskResult = (id) => api(`/api/tasks/${encodeURIComponent(id)}/result`);
var getTaskInspect = (id) => api(`/api/tasks/${encodeURIComponent(id)}/inspect`);
var getTaskFeedback = (id) => api(`/api/tasks/${encodeURIComponent(id)}/feedback`);
...
async function cancelTask(id) {
	return api(`/api/tasks/${encodeURIComponent(id)}/cancel`, {
		method: "POST",
		body: "{}"
	});
}
async function inputTask(id, message) {
	return api(`/api/tasks/${encodeURIComponent(id)}/input`, {
		method: "POST",
		body: JSON.stringify({ message })
	});
}
async function feedbackTask(id, verdict, message) {
	return api(`/api/tasks/${encodeURIComponent(id)}/feedback`, {
		method: "POST",
		body: JSON.stringify({
			verdict,
			message
...
async function sandboxPrepare() {
	return api("/api/runtime/sandbox/prepare", {
		method: "POST",
		body: "{}"
	});
}
...
function stateText(state) {
	...
	if ([
		...
		"READY_TO_INTEGRATE",
		"INTEGRATING"
	].includes(s)) return "Đang kiểm tra";
...
function systemHealth(runtime) {
	if (!runtime) return {
		label: "Đang kết nối",
		tone: "neutral",
		detail: "Đang đọc runtime MAR."
	};
	if (!runtime.sandbox_host_ready) return {
		label: "Cần xử lý",
		tone: "warning",
	...
	if (problems.length) return {
		label: "Suy giảm",
		tone: "warning",
		detail: problems.map((c) => `${connectionProvider(c)}: ${c.status}`).join(" · ")
	};
	return {
		label: "Hoạt động tốt",
		tone: "success",
		detail: "Sandbox và các route chính đang ổn định."
	};
}
function StatusBadge({ state, children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
		className: `status-badge ${stateTone(state || "")}`,
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleDot, { size: 12 }), children || stateText(state || "")]
	});
}
function EmptyState({ icon: Icon = ClipboardList, title, text }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { size: 34 }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: title }),
			text && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: text })
		]
	});
}
...
function TrendChart({ samples }) {
	if (samples.length < 2) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function ProviderZone({ provider, runtime }) {
	...
	const sessions = conns.reduce((n, c) => n + (c.active_sessions_available ? Number(c.active_sessions || 0) : 0), 0);
	const requests = conns.reduce((n, c) => n + Number(c.requests || 0), 0);
	const isClaude = provider === "Claude";
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		className: `panel provider-zone ${isClaude ? "claude" : "gpt"}`,
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "provider-head",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: `provider-brand ${isClaude ? "claude" : ""}`,
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bot, { size: 24 })
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: provider }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: isClaude ? "Claude Web · Streamable HTTP" : "GPT · Secure MCP Tunnel" })] }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						className: `connection-chip ${ready ? "connected" : "idle"}`,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "live-dot" }), ready ? "Đang kết nối" : "Idle"]
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Routes" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("b", { children: [
						ready,
						"/",
						conns.length
					] })] }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Sessions" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: sessions || "—" })] }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Requests" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: fmtNumber(requests) })] })
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("summary", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { size: 15 }), "Chi tiết bên dưới"] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "route-list",
				children: conns.length ? conns.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "route-row",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: c.name || c.id }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatusBadge, { state: routeReady(c) ? "RUNNING" : actionableConnection(c) ? "FAILED" : "CANCELLED" })]
				}, c.id)) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "muted",
					children: "Chưa có route."
				})
			})] })
		]
	});
}
function taskProjectHead(t, projects) {
	return String(projects.find((p) => p.id === t.project_id)?.head || "").trim();
}
function isHistoricalBlockedTask(t, projects) {
	const state = String(t.state || "").toUpperCase();
	if (!["BLOCKED", "FAILED"].includes(state)) return false;
	const base = String(t.base_revision || "").trim(), head = taskProjectHead(t, projects);
	return !!base && !!head && base !== head;
}
function isActionableBlockedTask(t, projects) {
	const state = String(t.state || "").toUpperCase();
	if (state === "INPUT_REQUIRED") return true;
	return ["BLOCKED", "FAILED"].includes(state) && !isHistoricalBlockedTask(t, projects);
}
function Overview({ runtime, tasks, usage, setView, workspace, projects }) {
	const scoped = workspace ? tasks.filter((t) => t.project_id === workspace) : tasks;
...
function TaskDetail({ id, reloadTasks, projects }) {
	...
	const refresh = async () => {
		...
		setLoading(true);
		try {
			const [s, r, i, f] = await Promise.allSettled([
				getTaskStatus(id),
				getTaskResult(id),
				getTaskInspect(id),
				getTaskFeedback(id)
			...
			setData({
				...
				inspect: i.status === "fulfilled" ? i.value : null,
				feedback: f.status === "fulfilled" ? f.value : null
			});
		} finally {
			setLoading(false);
		}
	...
	if (!id) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EmptyState, {
			icon: ClipboardList,
			title: "Chọn một task",
			text: "Trạng thái, result và evidence sẽ xuất hiện ở đây."
		})
	});
	if (!data) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EmptyState, {
			icon: LoaderCircle,
			title: loading ? "Đang tải task…" : "Chưa có dữ liệu"
		})
	});
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "eyebrow",
						children: task.contract?.project_id || "workspace"
					}),
			...
			result ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Metric, {
						label: "Integration",
						value: result.integration_status || "—"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Metric, {
						label: "Revision",
						value: String(result.final_revision || "—").slice(0, 12)
					})
				]
			}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "subtle-card",
				children: "Chưa có durable result."
			}),
			result && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", {
				className: "evidence",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("summary", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { size: 15 }), "Evidence / changed areas"] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", { children: JSON.stringify({
					changed_areas: result.changed_areas,
					pass_fail_evidence: result.pass_fail_evidence,
					unresolved_risks: result.unresolved_risks
				}, null, 2) })]
			}),
			needsInput && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "input-stack",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
					value: input,
					onChange: (e) => setInput(e.target.value),
					placeholder: "Nhập phần thông tin/quyết định MAR đang cần…"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					className: "primary-button",
					onClick: async () => {
						if (!input.trim()) return;
						await inputTask(id, input.trim());
						setInput("");
						await refresh();
						await reloadTasks();
					},
					children: "Gửi và tiếp tục"
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					onClick: async () => {
						if (confirm("Hủy task này?")) {
							await cancelTask(id);
							await refresh();
							await reloadTasks();
						}
					},
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleX, { size: 16 }), "Hủy task"]
				})]
			}),
			result && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "feedback-box",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "Phản hồi của bạn" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
						value: feedback,
						onChange: (e) => setFeedback(e.target.value),
						placeholder: "Bạn thấy gì khi dùng thật?"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								onClick: async () => {
									await feedbackTask(id, "ACCEPTED", feedback);
									setFeedback("");
									await refresh();
								},
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { size: 16 }), "Chấp nhận"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								onClick: async () => {
									await feedbackTask(id, "REJECTED", feedback);
									setFeedback("");
									await refresh();
								},
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleX, { size: 16 }), "Chưa đạt"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								onClick: async () => {
									await feedbackTask(id, "COMMENT", feedback);
									setFeedback("");
									await refresh();
								},
								children: "Ghi chú"
					...
					feedbackRows.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "feedback-history",
						children: feedbackRows.slice(0, 5).map((f, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: f.verdict }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: fmtTime(f.created_at) }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: f.message })
						] }, i))
					})
				]
			})
...
function CreateTaskPanel({ projects, preferredWorkspace, onCreated }) {
	const [project, setProject] = (0, import_react.useState)(preferredWorkspace || ""), [title, setTitle] = (0, import_react.useState)(""), [description, setDescription] = (0, import_react.useState)(""), [priority, setPriority] = (0, import_react.useState)("P2"), [verification, setVerification] = (0, import_react.useState)("go-standard"), [acceptance, setAcceptance] = (0, import_react.useState)(""), [busy, setBusy] = (0, import_react.useState)(false), [error, setError] = (0, import_react.useState)("");
	(0, import_react.useEffect)(() => {
		if (preferredWorkspace) setProject(preferredWorkspace);
	}, [preferredWorkspace]);
	const p = projects.find((x) => x.id === project);
	async function submit(e) {
		e.preventDefault();
		if (!p?.head || !title.trim()) return;
		setBusy(true);
		setError("");
		try {
			...
			await createTask({
				project_id: project,
				base_revision: p.head,
				goal: description.trim() ? `${title.trim()}\n\n${description.trim()}` : title.trim(),
				acceptance: accepts.length ? accepts : ["Hoàn thành đúng kết quả Owner yêu cầu và giữ hành vi không liên quan ổn định.", "Các verification phù hợp phải PASS trước khi candidate hoàn tất."],
				boundaries: [`Chỉ thay đổi project ${project}; không push/deploy từ Owner Console.`],
				non_goals: ["Không mở rộng kiến trúc ngoài yêu cầu task nếu không cần."],
				verification_profile: verification,
				priority,
				local_file_write: !!p.policy?.local_file_write,
				local_git_write: !!p.policy?.local_git_write,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "panel-title",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { size: 20 }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "Tạo task mới" })]
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "panel-subtitle",
				children: "Tạo tác vụ với workspace và MAR scheduler."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
				onSubmit: submit,
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: ["Workspace", /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
						value: project,
						onChange: (e) => setProject(e.target.value),
						required: true,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
							value: "",
							children: "Chọn workspace"
						}), projects.filter((x) => x.supported).map((x) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
							value: x.id,
							children: x.id
						}, x.id))]
					})] }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: ["Worker", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", {
						disabled: true,
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "Tự động · MAR scheduler" })
					})] }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: ["Tiêu đề task", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
						value: title,
						onChange: (e) => setTitle(e.target.value),
						required: true,
						placeholder: "Nhập tiêu đề ngắn gọn…"
					})] }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: ["Mô tả", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
						value: description,
						onChange: (e) => setDescription(e.target.value),
						placeholder: "Mô tả yêu cầu hoặc kết quả mong muốn…"
					})] }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("summary", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Settings, { size: 15 }), "Tùy chọn nâng cao"] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "advanced-fields",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: ["Verification", /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
								value: verification,
								onChange: (e) => setVerification(e.target.value),
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
									value: "go-standard",
									children: "go-standard"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
									value: "go-docs",
									children: "go-docs"
								})]
							})] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: ["Priority", /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
								value: priority,
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "P3" })
								]
							})] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: ["Acceptance", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
								value: acceptance,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							className: "primary-button",
							disabled: busy || !p?.head || !title.trim(),
							children: [busy ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, {
								className: "spin",
								size: 16
							}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { size: 16 }), "Tạo task"]
						})]
					})
				]
			})
...
function ConnectionsPage({ runtime, reload }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "page-header",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { children: "Connections" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Provider configuration, transport readiness và live activity." })] })
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "connection-grid",
			children: conns.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ConnectionCard, {
				c,
				reload
			}, c.id))
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			className: "panel sandbox-card",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "sandbox-icon",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { size: 24 })
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "Sandbox bảo vệ Windows" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: runtime?.sandbox_detail || "Không có chi tiết." })] }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatusBadge, { state: runtime?.sandbox_host_ready ? "COMPLETE" : "BLOCKED" }),
				!runtime?.sandbox_host_ready && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					className: "primary-button",
					onClick: async () => {
						await sandboxPrepare();
						await reload();
					},
					children: "Chuẩn bị sandbox"
				})
			]
		})
	] });
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: `provider-brand ${provider === "Claude" ? "claude" : ""}`,
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bot, { size: 24 })
					}),
			...
			c.identifier && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "copy-row",
...
function UsagePage({ usage, workspace }) {
	const days = usage?.daily || [];
	const max = Math.max(1, ...days.map((d) => Number(d.total_tokens || 0)));
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "page-header",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { children: "Usage" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [workspace ? `Workspace: ${workspace}` : "Tất cả workspaces", " · durable result token counters."] })] })
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			className: "summary-cards three",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Hôm nay" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: usageWindowValue(usage?.today) }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("small", { children: [
							fmtNumber(usage?.today?.input_tokens),
							" input · ",
							fmtNumber(usage?.today?.output_tokens),
							" output"
						] })
					] })]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChartColumn, { size: 25 })
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Tuần này" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: usageWindowValue(usage?.week) }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("small", { children: "Tuần lịch local" })
					] })]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "summary-card",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "All time" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: usageWindowValue(usage?.all_time) }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("small", { children: [fmtNumber(usage?.all_time?.results_with_token_data), " results measured"] })
					] })]
				})
			]
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "panel-title",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChartColumn, { size: 20 }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "30 ngày gần nhất" })]
				})
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "usage-bars",
				children: days.map((d) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "usage-bar-wrap",
					title: `${d.date}: ${fmtNumber(d.total_tokens)} tokens`,
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "usage-bar",
						style: { height: `${Math.max(2, Number(d.total_tokens || 0) / max * 100)}%` }
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: String(d.date || "").slice(8) })]
				}, d.date))
			})]
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "panel-title",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Database, { size: 20 }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "Input / Output theo ngày" })]
				})
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Ngày" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Input" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Output" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Tổng" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Coverage" })
				] }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: [...days].reverse().map((d) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: d.date }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: fmtNumber(d.input_tokens) }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: fmtNumber(d.output_tokens) }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: fmtNumber(d.total_tokens) }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", { children: [
						fmtNumber(d.results_with_token_data),
						"/",
						fmtNumber(d.results)
					] })
				] }, d.date)) })] })
...
function DiagnosticsPage({ runtime, reload }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "page-header",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { children: "Diagnostics" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Technical evidence dành cho Tech Lead/debug." })] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			onClick: reload,
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(RefreshCw, { size: 16 }), "Làm mới"]
		})]
	}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "panel-title",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SquareTerminal, { size: 20 }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "Runtime" })]
				})
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", { children: JSON.stringify(runtime, null, 2) })]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			className: "panel",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "panel-title",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { size: 20 }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "Normal flow" })]
					})
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flow-principle",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Owner" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "→" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Tech Lead Web" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "→" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "MAR" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "→" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Worker" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "→" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Verified result" })
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					className: "primary-button",
					disabled: runtime?.sandbox_host_ready,
					onClick: async () => {
						await sandboxPrepare();
						await reload();
					},
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { size: 16 }), runtime?.sandbox_host_ready ? "Sandbox ready" : "Chuẩn bị sandbox"]
				})
			]
		})]
	})] });
...
function App() {
	...
	const [view, setViewState] = (0, import_react.useState)(views.some((v) => v.id === initialHash) ? initialHash : "live");
	const [runtime, setRuntime] = (0, import_react.useState)(null), [projects, setProjects] = (0, import_react.useState)([]), [tasks, setTasks] = (0, import_react.useState)([]), [usage, setUsage] = (0, import_react.useState)(null), [workspace, setWorkspaceState] = (0, import_react.useState)(() => localStorage.getItem("mar.owner.workspace.react.v1") || ""), [tokenSamples, setTokenSamples] = (0, import_react.useState)([]), [error, setError] = (0, import_react.useState)("");
	...
	const setWorkspace = (value) => {
		...
		localStorage.setItem("mar.owner.workspace.react.v1", value);
	};
	...
	const reloadUsage = async () => {
		setUsage(await getUsage(workspaceRef.current));
	};
	(0, import_react.useEffect)(() => {
		Promise.all([
			reloadRuntime(),
	...
	else if (view === "overview") content = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Overview, {
		runtime,
		tasks,
		usage,
		setView,
	...
	else if (view === "tasks") content = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TasksPage, {
		tasks,
		projects,
		workspace,
		reloadTasks
	...
	else if (view === "usage") content = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(UsagePage, {
		usage,
		workspace
	});
	else content = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DiagnosticsPage, {
		runtime,
		reload: reloadRuntime
	});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Shell, {
		...
		children: [error && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TriangleAlert, { size: 16 }), error]
		}), content]
	});
}
//#endregion
